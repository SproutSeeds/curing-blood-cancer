...
| `synthetic_state_assay_specimen_quality_failure_v0` | `msv_00`, `msv_01`, `msv_02`, `msv_03`, `msv_06`, `msv_10` through `msv_16`. | Missing method, threshold, specimen quality, timing, paired modality, imaging criteria, spatial sampling, host-context separation, private review need, or modality collapse remains visible and refuses comparison, endpoint interpretation, prognosis, monitoring, treatment, ranking, and decisions. |
