...
1. `measurement-refusal-wrapper-negative-safety-fixtures-v0`
...
fields, and public processing of private quality-review requests. The top
remaining recommendation is now
`measurement-refusal-wrapper-negative-safety-fixtures-v0`, because
`measurement-refusal-wrapper-integration-dry-run-v0` has mapped the validated
refusal records into the model-output boundary wrapper without creating model
output, and that wrapper surface should get the same adversarial fail-closed
pressure.
