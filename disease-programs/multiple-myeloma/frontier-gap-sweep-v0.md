...
1. `measurement-refusal-wrapper-integration-dry-run-v0`
...
remaining recommendation is `measurement-refusal-wrapper-integration-dry-run-v0`,
because the validated refusal records now need a synthetic dry run into the
model-output boundary wrapper without creating any model output.
