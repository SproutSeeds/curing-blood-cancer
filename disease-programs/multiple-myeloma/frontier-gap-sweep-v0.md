...
1. `measurement-refusal-wrapper-state-machine-v0`
...
adversarial fail-closed coverage for unsafe wrapper mutations. The top
remaining recommendation is now `measurement-refusal-wrapper-state-machine-v0`,
because the allowed wrapper states and transitions should be explicit before
any model-output reuse.
