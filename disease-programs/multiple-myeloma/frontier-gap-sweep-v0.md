...
| --- | --- | --- | --- | --- |
| `fgs_01_modality_discordance` | Discordance among marrow MRD, blood-based residual disease, imaging, and spatial/marrow-biopsy signals. | A patient-state engine that collapses discordant residual-disease modalities into one flag will be brittle. | Create `residual-disease-modality-discordance-source-extraction-v0` covering marrow MRD, blood MS, PET-CT/MRI, and spatial biopsy context. | No patient MRD interpretation, monitoring advice, imaging advice, or prognosis. |
...
| `fgs_04_assay_and_specimen_quality` | Sample quality, hemodilution, missingness, failed assays, sensitivity, threshold, timing, and method lineage. | The machine stack needs refusal reasons for bad or incomplete measurement context before it needs better prediction heads. | Add an assay/specimen-quality failure-mode checklist linked to the model-output wrapper. | No lab interpretation or test-ordering advice. |
...
1. `residual-disease-modality-discordance-source-extraction-v0`
2. `spatial-imaging-residual-disease-context-v0`
3. `blood-based-mrd-mass-spectrometry-context-v0`
4. `assay-specimen-quality-failure-mode-checklist-v0`
5. `fitness-toxicity-pro-context-source-extraction-v0`
6. `model-validation-transportability-bias-map-v0`
7. `fusion-architecture-method-source-extraction-v0`

The top recommendation is
`residual-disease-modality-discordance-source-extraction-v0`, because it ties
MRD, blood, imaging, spatial disease, assay quality, and output refusal
together without needing real case data or external outreach.
