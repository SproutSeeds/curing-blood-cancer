...
the cure-oriented questions easier to define, inspect, score, and improve from
transparent sources.

## First Cure Wedge

[Durable MRD-negative remission and relapse prevention](cure-wedge-durable-mrd-negative-remission-v0.md)

This wedge asks where current and emerging myeloma strategies produce deep
responses, why those responses stop being durable for some people, and which
research directions deserve structured public tracking.
...
- Public artifacts must preserve source IDs, uncertainty, and disease-state
  scope.
...
- `case-intake/`: public-safe caregiver intake specifications and synthetic
  fixture contracts
- `contexts/`: high-risk, organ, frailty, and disease-context boundary maps
- `mechanisms/`: mechanism maps and relapse-biology notes
- `measurements/`: MRD, response, relapse, and endpoint definitions
- `precursors/`: MGUS, smoldering myeloma, risk, and interception boundary notes
...
- `therapy-landscapes/`: immune therapy and product/trial access-boundary maps
...
- [Disease Map Schema v0](../../schemas/disease-map-schema-v0.md)
- [Target Record Schema v0](../../schemas/target-record-schema-v0.md)
...
- [Tooling Readiness Gate v0](tooling-readiness-gate-v0.md)
...
- [Measurement Refusal Negative Safety Fixtures v0](measurements/measurement-refusal-negative-safety-fixtures-v0.md)
- [Measurement Refusal Wrapper Integration Dry Run v0](measurements/measurement-refusal-wrapper-integration-dry-run-v0.md)
- [Measurement Refusal Wrapper Negative Safety Fixtures v0](measurements/measurement-refusal-wrapper-negative-safety-fixtures-v0.md)
- [Measurement Refusal Wrapper State Machine v0](measurements/measurement-refusal-wrapper-state-machine-v0.md)
...
- [Public Translation And Contribution Guide v0](public-translation-contribution-guide-v0.md)
...
- [MRD Resistance Geometry Axis Revision v0](mechanisms/mrd-resistance-geometry-axis-revision-v0.md)
