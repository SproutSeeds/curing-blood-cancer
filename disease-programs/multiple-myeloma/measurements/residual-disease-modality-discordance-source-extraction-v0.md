...
`measurement-refusal-negative-safety-fixtures-v0`, after the assay/specimen
quality checklist, measurement-state refusal fixture extension,
measurement-refusal output schema, measurement-refusal output route table, and
