...
modality-discordance extraction, and assay/specimen quality failure-mode
checklist, measurement-state refusal fixtures, and the measurement-state
refusal fixture checker are
...
| Class | Count | Meaning |
| --- | ---: | --- |
| dataset | 23 | Catalogs, public task queues, evidence-gap records, measurement context, issue indexes, response ledgers, outreach maps, source registry, source extraction, source-gap task routing, failure-mode checklists, measurement refusal fixtures, and synthetic examples. |
...
| tool | 3 | Review-packet manifest route-table dry-run tool, measurement-state refusal fixture checker, and static synthetic caregiver intake frontend. |
...
52. [Public Artifact Catalog v0](../../artifacts/public-artifact-catalog-v0.md)
...
- `measurement-refusal-output-schema-v0` to define the non-clinical output
  envelope for the now-checked refusal states
