...
| Class | Count | Meaning |
| --- | ---: | --- |
| dataset | 22 | Catalogs, public task queues, evidence-gap records, measurement context, issue indexes, response ledgers, outreach maps, source registry, source extraction, source-gap task routing, failure-mode checklists, and synthetic examples. |
...
51. [Public Artifact Catalog v0](../../artifacts/public-artifact-catalog-v0.md)
...
quality failure-mode checklist.
Protected-branch or
