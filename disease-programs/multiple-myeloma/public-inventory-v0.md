...
safety fixtures/checker, and the measurement refusal checkers are
...
| Class | Count | Meaning |
| --- | ---: | --- |
| dataset | 41 | Catalogs, public task queues, evidence-gap records, measurement context, issue indexes, response ledgers, outreach maps, source registry, source extraction, source-gap task routing, failure-mode checklists, measurement refusal fixtures, refusal output fixtures, negative safety fixtures, validator reports, and synthetic examples. |
...
56. [Measurement Refusal Negative Safety Fixtures v0](measurements/measurement-refusal-negative-safety-fixtures-v0.md)
   ...
   fail closed.
57. [Public Artifact Catalog v0](../../artifacts/public-artifact-catalog-v0.md)
...
report, negative safety fixtures/checker, and checkers.
Protected-branch or
...
- `measurement-refusal-wrapper-integration-dry-run-v0` to dry-run how refused
  measurement outputs touch the model-output wrapper without clinical output,
  route expansion, real data, ranking, or publication authorization
