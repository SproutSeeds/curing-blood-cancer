...
measurement-refusal output fixture, and the measurement refusal checkers are
...
| map | 13 | Cure-wedge, open research, concept, mechanism, geometry, immune-therapy boundary, post-BCMA frontier addendum, context-modifier, case-to-cure stage, and myeloma state validator rule maps. |
...
| tool | 7 | Review-packet manifest route-table dry-run tool, MRD geometry checkers, measurement-state refusal fixture checker, measurement-refusal output schema checker, and static synthetic caregiver intake frontend. |
...
54. [Public Artifact Catalog v0](../../artifacts/public-artifact-catalog-v0.md)
...
fixtures, refused output records, and checkers.
Protected-branch or
...
- `measurement-refusal-output-route-table-v0` to define deterministic routing
  for the now-checked refused measurement-output records
