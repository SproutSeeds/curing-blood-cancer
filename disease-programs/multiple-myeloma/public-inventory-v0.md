...
measurement-refusal validator skeleton/report, and the measurement refusal
checkers are
...
| Class | Count | Meaning |
| --- | ---: | --- |
| dataset | 40 | Catalogs, public task queues, evidence-gap records, measurement context, issue indexes, response ledgers, outreach maps, source registry, source extraction, source-gap task routing, failure-mode checklists, measurement refusal fixtures, refusal output fixtures, validator reports, and synthetic examples. |
...
| tool | 9 | Review-packet manifest route-table dry-run tool, MRD geometry checkers, measurement-state refusal fixture checker, measurement-refusal output schema checker, measurement-refusal route-table checker, measurement-refusal validator skeleton checker, and static synthetic caregiver intake frontend. |
...
56. [Public Artifact Catalog v0](../../artifacts/public-artifact-catalog-v0.md)
...
- `measurement-refusal-negative-safety-fixtures-v0` to add synthetic
  adversarial fixtures for missing routes, duplicated routes, unsafe
  destination contracts, clinical fields, ranking fields, and real-review
  requests
