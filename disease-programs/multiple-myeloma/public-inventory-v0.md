...
| tool | 11 | Review-packet manifest route-table dry-run tool, MRD geometry checkers, measurement-state refusal fixture checker, measurement-refusal output schema checker, measurement-refusal route-table checker, measurement-refusal validator skeleton checker, measurement-refusal negative safety fixture checker, measurement-refusal wrapper integration dry-run checker, and static synthetic caregiver intake frontend. |
...
58. [Public Artifact Catalog v0](../../artifacts/public-artifact-catalog-v0.md)
...
report, negative safety fixtures/checker, wrapper dry-run report/checker, and
checkers.
Protected-branch or
...
- `measurement-refusal-wrapper-negative-safety-fixtures-v0` to adversarially
  test the wrapper dry-run surface without clinical output, route expansion,
  real data, ranking, or publication authorization
