...
| MRD and endpoints | [MRD Endpoint Language Guardrail Addendum v0](measurements/mrd-endpoint-language-guardrail-addendum-v0.md) plus [Residual Disease Modality Discordance Source Extraction v0](measurements/residual-disease-modality-discordance-source-extraction-v0.md) and [Assay Specimen Quality Failure Mode Checklist v0](measurements/assay-specimen-quality-failure-mode-checklist-v0.md) | `measurement-state-refusal-fixture-extension-v0` synthetic fixture pressure | `make validate` plus source IDs | response depth, residual-disease modality context, and assay/specimen quality failure states cannot be read as cure, prognosis, monitoring, treatment, lab validity, assay ranking, modality ranking, or global disease-state claims |
