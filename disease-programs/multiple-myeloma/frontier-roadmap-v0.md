...
complete as structural validation only. The next no-outreach public-source
successor, if selected, is `measurement-refusal-negative-safety-fixtures-v0`.
