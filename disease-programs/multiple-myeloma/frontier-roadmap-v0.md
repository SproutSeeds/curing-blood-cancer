...
| MRD and endpoints | [MRD Endpoint Language Guardrail Addendum v0](measurements/mrd-endpoint-language-guardrail-addendum-v0.md) plus [Residual Disease Modality Discordance Source Extraction v0](measurements/residual-disease-modality-discordance-source-extraction-v0.md), [Assay Specimen Quality Failure Mode Checklist v0](measurements/assay-specimen-quality-failure-mode-checklist-v0.md), [Measurement State Refusal Fixtures v0](../../examples/measurement-state-refusal-fixtures-v0.json), and [Measurement Refusal Output Schema v0](../../schemas/measurement-refusal-output-schema-v0.md) | `measurement-refusal-output-route-table-v0` refusal output routing | `make validate`, `make check-measurement-state-refusal-fixtures`, `make check-measurement-refusal-output-schema`, plus source IDs | response depth, residual-disease modality context, and assay/specimen quality failure states cannot be read as cure, prognosis, monitoring, treatment, lab validity, assay ranking, modality ranking, or global disease-state claims |
...
The measurement-state refusal fixture extension and measurement-refusal output
schema are also complete and checked. The next no-outreach public-source
successor, if selected, is `measurement-refusal-output-route-table-v0`.
