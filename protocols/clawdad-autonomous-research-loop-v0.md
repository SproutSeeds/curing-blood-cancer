...
1. Work the active ORP additional item in the active ORP additional list,
   ...
   validator skeleton/report, and measurement-refusal negative safety
...
2. When an item completes, synthesize and activate or queue the next safe item
   ...
   measurement-refusal validator skeleton, and measurement-refusal negative
   safety fixtures are now complete; the
